...
class ConfigOpenInBrowserAction : ConfigCatBaseAnAction() {
    companion object {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val url =
            state.dashboardBaseUrl + "/" + productParent.product.productId + "/" + selectedNode.config.configId
    ...
    override fun update(e: AnActionEvent) {
        val selectedElement: DefaultMutableTreeNode? = e.project?.service<ProductsConfigsPanel>()?.getSelectedNode()
        updateVisibility(e, selectedElement?.userObject is ConfigNode)
    }
