...
import com.configcat.intellij.plugin.toolWindow.ViewData
...
//        var rawHtml = dataOut.toString(Charsets.UTF_8);
    ...
    override fun dispose() {
        try {
            ...
            Logger.getInstance(CefStreamResourceHandlerWithHtmlOverwrite::class.java).warn("Failed to close the stream", e)
        }
    }
}
